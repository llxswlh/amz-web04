    ...
    <Layout>
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center max-w-4xl mx-auto text-gray-600 leading-relaxed mb-16">
          <p className="mb-4">
            TMG (Transport Media Group)
            交运传媒是在华东地区注册的三四线城市媒体广告传媒公司，独立注册资金9600万,
          </p>
          <p className="mb-4">
            TMG打造的"
          ...
          <p className="mb-4">
            覆盖中国
            <span className="text-3xl font-bold text-gray-800 mx-1">26</span>
            个省份、含
            <span className="text-3xl font-bold text-gray-800 mx-1">300</span>
            余个城市、近
            <span className="text-3xl font-bold text-gray-800 mx-1">2000</span>
            个县市区域；
          </p>
          <p className="mb-4">整合全国各大城市��路客运站媒体，</p>
          <p>致力为品牌提供渠道和市场下沉轨道新传播模式和落地服务；</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          ...
          <div className="bg-blue-50 rounded-3xl p-6 py-12 text-center flex flex-col items-center justify-center w-full h-80">
            ...
            <p className="text-5xl font-light text-gray-800">
              1800<sup className="text-2xl">+</sup>
              <span className="text-3xl">个</span>
            </p>
          ...
          <div className="bg-yellow-50 rounded-3xl p-6 py-12 text-center flex flex-col items-center justify-center w-full h-80">
            ...
            <p className="text-5xl font-light text-gray-800">
              10000<sup className="text-2xl">+</sup>
              <span className="text-3xl">个</span>
            </p>
